...
-- CreateEnum
CREATE TYPE "CarStatus" AS ENUM ('AVAILABLE', 'SOLD', 'UNAVAILABLE');
...
-- CreateIndex
CREATE UNIQUE INDEX "DealershipInfo_name_key" ON "DealershipInfo"("name");

-- CreateIndex
CREATE UNIQUE INDEX "DealershipInfo_phone_key" ON "DealershipInfo"("phone");

-- CreateIndex
CREATE UNIQUE INDEX "DealershipInfo_email_key" ON "DealershipInfo"("email");
